...
Provide your syllabus and deadlines
Let the Planner Agent create a personalized study plan
Use the Summarizer Agent to process study materials
Generate quizzes with the Quiz Agent
Track progress with the Session Manager
🧪 Example Workflow
